function [E, A, rV_mag, rE_mag, rV_ang, rE_ang] = analyzeDecoderOrEncoder(Mtx, ls_dirs, type, angRes, PLOT_ON, INFO_ON)
...
if PLOT_ON
    ...
    title(sprintf('Amplitude A [dB], zero-mean (%.1f dB)', mean_A))
    ...
    title(sprintf('Energy E [dB], zero-mean (%.1f dB)', mean_E))
